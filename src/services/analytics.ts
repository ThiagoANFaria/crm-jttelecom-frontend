...
class AnalyticsService {
  ...
  async getOverview(filters?: AnalyticsFilters): Promise<AnalyticsOverview> {
    try {
      const response = await apiService.get('/analytics/overview', { params: filters });
  ...
  async getFunnelMetrics(filters?: AnalyticsFilters): Promise<FunnelMetrics> {
    try {
      const response = await apiService.get('/analytics/funnel', { params: filters });
      return response.data;
    } catch (error) {
  ...
  async getRevenueAnalytics(filters?: AnalyticsFilters): Promise<RevenueAnalytics> {
    try {
      const response = await apiService.get('/analytics/revenue', { params: filters });
      return response.data;
    } catch (error) {
  ...
  async getStageAnalytics(filters?: AnalyticsFilters): Promise<StageAnalytics> {
    try {
      const response = await apiService.get('/analytics/stages', { params: filters });
      return response.data;
    } catch (error) {
  ...
  async getConversionTrends(filters?: AnalyticsFilters) {
    try {
      const response = await apiService.get('/analytics/conversion-trends', { params: filters });
      return response.data;
    } catch (error) {
  ...
  async getBottleneckAnalysis(filters?: AnalyticsFilters) {
    try {
      const response = await apiService.get('/analytics/bottlenecks', { params: filters });
      return response.data;
    } catch (error) {
  ...
  async getRevenueProjections(months: number = 3) {
    try {
      const response = await apiService.get('/analytics/revenue-projections', { 
        params: { months } 
      });
      return response.data;
    } catch (error) {
  ...
  async getTeamPerformance(filters?: AnalyticsFilters) {
    try {
      const response = await apiService.get('/analytics/team-performance', { params: filters });
      return response.data;
    } catch (error) {
  ...
  async getChartData(chartType: string, filters?: AnalyticsFilters) {
    try {
      const response = await apiService.get(`/analytics/charts/${chartType}`, { params: filters });
      return response.data;
    } catch (error) {
  ...
  async getPeriodComparison(
    ...
    try {
      const response = await apiService.post('/analytics/period-comparison', {
  ...
  async getAIInsights(filters?: AnalyticsFilters) {
    try {
      const response = await apiService.get('/analytics/ai-insights', { params: filters });
      return response.data;
    } catch (error) {
