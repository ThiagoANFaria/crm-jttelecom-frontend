...
class NotificationService {
  ...
  initializeWebSocket(userId: string) {
    try {
      const wsUrl = process.env.NODE_ENV === 'production' 
        ? `wss://apiService.jttecnologia.com.br/ws/notifications?user_id=${userId}`
  ...
  async getNotifications(filters?: {
    ...
    try {
      const response = await apiService.get('/notifications', { params: filters });
  ...
  async updateTemplate(templateId: string, template: Partial<NotificationTemplate>) {
    try {
      const response = await apiService.patch(`/notifications/templates/${templateId}`, template);
      return response.data;
    } catch (error) {
  ...
  async createRule(rule: Omit<NotificationRule, 'id'>) {
    try {
      const response = await apiService.post('/notifications/rules', rule);
      return response.data;
    } catch (error) {
  ...
  async updateRule(ruleId: string, rule: Partial<NotificationRule>) {
    try {
      const response = await apiService.patch(`/notifications/rules/${ruleId}`, rule);
      return response.data;
    } catch (error) {
  ...
  async testRule(ruleId: string, testData: any) {
    try {
      const response = await apiService.post(`/notifications/rules/${ruleId}/test`, testData);
      return response.data;
    } catch (error) {
  ...
  async sendTestPush() {
    try {
      const response = await apiService.post('/notifications/test-push');
      return response.data;
    } catch (error) {
