...
// Interface para usuário Master (fora da estrutura de tenants)
...
// Interface para usuário comum (dentro de tenant)
export interface TenantUser {
  id: string;
  name: string;
  email: string;
  user_level: UserType.ADMIN | UserType.USER;
  tenant_id: string;
  tenant_name: string;
  created_at: string;
  last_login?: string;
...
export interface User {
  ...
  company_name?: string;
  user_level: UserType;
  tenant_id?: string; // Apenas para admin/user, Master não tem tenant
  tenant_name?: string; // Apenas para admin/user, Master não tem tenant
  created_at: string;
  last_login?: string;
}

// Interface para gestão de tenants (apenas Master)
