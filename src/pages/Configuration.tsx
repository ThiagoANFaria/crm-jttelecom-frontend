...
import ContractTemplatesManager from '@/components/configuration/ContractTemplatesManager';
...
const Configuration: React.FC = () => {
  ...
  const configurationSections = [
    ...
    },
    {
      ...
      description: 'Templates personalizáveis para contratos com renovação automática',
      icon: FileText,
      color: 'bg-blue-500',
      component: ContractTemplatesManager
    },
    {
      id: 'products',
    ...
    },
    {
      id: 'automation',
      title: 'Automações',
      description: 'Criar e gerenciar automações e cadências (Restrito a Administradores)',
      icon: Zap,
      color: 'bg-red-500',
      component: AutomationFlowBuilder
    }
  ];
